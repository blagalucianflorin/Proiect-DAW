        ...
        <div class="col-sm-6">
            ...
            <div class="card border-primary" style="width: auto;">
                ...
                <div class="card-header">
                    <h4>Ticket Manager Overview <i class="fas fa-list"></i></h4>
                </div>

                <div class="card-body w-100">

                    <h5>Scope</h5>
                    <p>The purpose of this page is to manage the routes available.</p>
                    <br>

                    <h5>Entry point:</h5>
                    <p>This page can be accessed from any other page using the 'Profile' dropdown from the navigation bar.</p>
                    <p>Only accessible to administrator users.</p>
                    <br>
                    ...
                    <ul>
                        <li><p>Add route</p></li>
                        <li><p>Delete route</p></li>
                        <li><p>Change route</p></li>
                    </ul>
